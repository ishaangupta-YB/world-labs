/**
 * Cooper Station Demo - Three.js + Rapier Physics + Gaussian Splats
 *
 * Experience the massive rotating space station from Interstellar featuring:
...
const CONFIG = {
	...
	// Assets - Using cooper_station.spz
	ENVIRONMENT: {
		SPLATS: getAssetUrl(ASSETS.MODELS.COOPER_STATION),
		SPLAT_SCALE: 3,
	},
};
...
async function init() {
	...
	// console.log("🚀 Cooper Station world initialized successfully!");
}
