/**
 * Dis1 World Demo - Three.js + Rapier Physics + Gaussian Splats
 *
 * A simplified world implementation featuring:
...
const CONFIG = {
	...
	// Assets - Using dis1.spz
	ENVIRONMENT: {
		SPLATS: getAssetUrl(ASSETS.MODELS.DIS1),
		SPLAT_SCALE: 3,
	},
};
...
async function init() {
	...
	console.log("🚀 Dis1 world initialized successfully!");
}
