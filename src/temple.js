/**
 * Temple Demo - Three.js + Rapier Physics + Gaussian Splats
 *
 * Experience the ancient temple grounds featuring:
...
const CONFIG = {
	...
	// Assets - Using temple.spz
	ENVIRONMENT: {
		SPLATS: getAssetUrl(ASSETS.MODELS.TEMPLE),
		SPLAT_SCALE: 3,
	},
};
